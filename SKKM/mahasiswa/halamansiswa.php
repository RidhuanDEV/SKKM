...
<body class="bg-gray-900">
    <main id="kotak-utama" class="w-full min-h-screen flex overflow-auto ">
        <section id="kotak-kiri" class="w-3/4 h-full block">
            ...
            <article id="beranda-utama" class="opacity-100 w-full overflow-auto h-screen bg-gray-100">
            ...
            <article id="beranda-skkm" class="overflow-auto opacity-0 w-0 h-0  bg-gray-100">
                <div class="w-full h-full">
                    ...
                    <p>5. Jika pengajuan anda di tolak maka daftar pengajuan SKKM anda akan hilang dari daftar pengajuan dan tidak akan masuk</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;ke daftar SKKM yang telah anda kumpulkan.</p>
                    ...
                    <p>10. <span>WAJIB</span> mengganti nama file yang akan anda upload dengan (NRP anda) - namafile (tidak boleh sama dengan file yang sudah di ajukan)</p>
                </div>
                ...
                <table class=" overflow-x-auto w-full">
                    ...
                    <tbody>
                        <?php
                            ...
                            echo "<tr><td colspan='6' class='py-3 text-center text-black border border-solid border-black px-5'>Anda tidak memiliki Pengajuan untuk saat ini.</td></tr>";
                        }
                        ?>
                        </tbody>
                </table>
                ...
                <table class=" overflow-x-auto ">
                    ...
                    <tbody>
                        ...
                        if($total == 6){
                            echo "<tr><td colspan='6' class='py-3 text-center text-black border border-solid border-black px-5'>Anda tidak memiliki SKKM untuk saat ini.</td></tr>";
                        }
        ...
        <aside id="kotak-kanan" class="w-1/4 h-screen p-2  bg-slate-600 border-collapse">
            <div
            ...
            <div class="w-full h-3/6 border-4 border-collapse border-slate-600 rounded-xl block p-2 bg-gray-100">
                <?php 
                $nrp = $_SESSION['user_id']['nrp'];
                $select = "SELECT * FROM datamahasiswa WHERE nrp = $nrp";
                $eksekusi = $koneksi->query($select);
                ...
                <div class = 'w-full h-2/3 rounded-md flex justify-center items-center bg-cover overflow-hidden'>
                    <img src='../data/$nrp/".$row["foto"]."' alt='STUDENT PHOTOS' class='justify-center items-center flex w-auto h-56 overflow-hidden bg-cover'>
                </div>
                <h4 id='userprofil' class='text-lg font-semibold font-mono'>Nama : ".$row["nama"]."</h4>
                <h4 id='userprofil' class='text-lg font-semibold font-mono'>NIM : ".$row["nrp"]."</h4>
                <h4 id='userprofil' class='text-lg font-semibold font-mono'>Tahun Angkatan: ".$row["angkatan"]."</h4>
                <h4 id='userprofil' class='text-lg font-semibold font-mono'>Email : ".$row["email"]."</h4>
                ";
            ?>
            </div>
            <div class="w-full flex flex-col h-2/6 p-2 border-4 border-slate-600 rounded-xl bg-gray-100">
                ...
                <div class=" flex-1 flex flex-col ">
                    <div class="flex  items-center pl-4">
                        <a aria-label="skkm.iti.ac.id" href="mailto: ridhuandf1@gmail.com"><img alt="Send Mail"
                                src="../assets/icons8-email-64.png" class=" w-10 h-10"></a>
                        <a href="mailto: ridhuandf1@gmail.com" class="hover:text-blue-400 hover:underline pl-2 active:text-red-500">pka.iti.ac.id</a>
                    </div>
                    <div class="flex items-center pl-4">
                        <a aria-label="Ridhuan" href="https://wa.me/082113472156"><img alt="Chat on WhatsApp"
                                src="../assets/icons8-whatsapp.svg" class="w-10 h-10"></a>
                        <a aria-label="Ridhuan" href="https://wa.me/082113472156" class="hover:text-blue-400 hover:underline pl-2 active:text-red-500">Admin PKA</a>
                    </div>
                    <div class="flex items-center pl-4">
                        <a aria-label="Instagram PKA" href="https://www.instagram.com/pka_iti/" target="_blank"><img
                                alt="DM on Instagram" src="../assets/icons8-instagram.svg" class="w-10 h-10" target="_blank"></a>
                        <a aria-label="Instagram PKA" href="https://www.instagram.com/pka_iti/" target="_blank" class="hover:text-blue-400 hover:underline pl-2 active:text-red-500">pka_iti</a>
                    </div>
                </div>
