...
if($_SESSION['user_id']['role'] == 'admin' || $_SESSION['user_id']['role'] == 'admin pka' ){
$nrp = $_GET['nrp'];
}else{
...
<body>
    <div class="w-full h-screen flex justify-center items-center bg-cover" style="background-image: url(reset.jpg)">
        <div class="w-1/4 h-1/2">
            ...
            <?php
                ...
                echo ($_SESSION['user_id']['role'] != 'admin' && $_SESSION['user_id']['role'] != 'admin pka'?"
